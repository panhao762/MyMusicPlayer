...
public class SongListPanel extends JScrollPane {
	// 菜单项相关
		...
		private void createAction()
		{
			...
			addLrcFloder.addActionListener(
					event->{
